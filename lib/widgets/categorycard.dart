                    ...
                    child: Stack(
                      children: [
                        ...
                        child:  Padding(
                          ...
                          child: Row(
                            children: [
                            CategoryIcon(color: this.category.color, iconName: this.category.icon),
                            SizedBox(width: 10,), 
  Text(this.category.name,style: TextStyle(color: Colors.white,fontSize: 25 ,
                            ),)
                            ]
